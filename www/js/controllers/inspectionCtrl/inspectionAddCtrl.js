...
$scope.getBackgroundGeolocation($scope.toServeremployeekey);
    // console.log("INSIDE inspectionAddCtrl");
...
$scope.AddInspectionOrder = function(showWorkorder){  
    ...
    if($scope.inspectionAdd.SupervisorKey){
        $scope.inspectionAdd.supervisorKey = $scope.inspectionAdd.SupervisorKey.SupervisorKey;
    }
    else{
        var alertPopup = $ionicPopup.alert({
                                title: 'Submit failed',
...
$scope.myPromise = $http.get($scope.serverLocation +"/scoringtype?OrganizationID="+$scope.OrganizationID)
                .success(function (response)
...
$scope.myPromise = $http.get($scope.serverLocation +"/getAllEmployeesDetailsOnly?OrganizationID="+$scope.OrganizationID)
                .success(function (response)
...
$scope.myPromise = $http.get($scope.serverLocation +"/supervisorname?employeekey="+$scope.toServeremployeekey+"&OrganizationID="+$scope.OrganizationID)
                .success(function (response)
...
$scope.myPromise = $http.get($scope.serverLocation +"/getTemplatesNameFor_Mob?employeekey="+$scope.toServeremployeekey+"&OrganizationID="+$scope.OrganizationID)
                .success(function (response)
...
$scope.myPromise = $http.get($scope.serverLocation +"/allfacility?empkey="+$scope.toServeremployeekey+"&OrganizationID="+$scope.OrganizationID)
                .success(function (response)
