...
// });
     ...
     $scope.myPromise = $http.get(HOSTNAME + "/allfacility?empkey="+$scope.toServeremployeekey+"&OrganizationID="+$scope.OrganizationID )//  status /roomtype  /employee
...
// $ionicLoading.hide();
  ...
  $scope.myPromise =  $http.get(HOSTNAME + "/zoneByFacility_Floor?fkey="+facilitykey+"&floorkey="+floor_key+"&OrganizationID="+$scope.OrganizationID)
   ...
   $scope.getAllWorkorderByFacilityFloorZone = function(facilitykey, zonekey, floorkey){
      ...
      // $ionicLoading.show();
    $scope.myPromise =  $http.get(HOSTNAME + "/viewworkorderFilterByFacility?facilitykey=" + facilitykey+"&zone="+ zonekey +"&floor="+ floorkey + "&today="+$scope.today_DT+"&employeekey="+$scope.toServeremployeekey+"&OrganizationID="+$scope.OrganizationID)
            .success(function(response)
            {
              // $ionicLoading.hide();
               // debugger; 
