...
//                    console.log("workorder time parsed  " + workTime);
        ...
        $scope.myPromise = $http.get(HOSTNAME +"/allWorkordertype?empkey="+$scope.toServeremployeekey+"&OrganizationID="+$scope.OrganizationID)
            .success(function(response)
            {
              // $ionicLoading.hide();
        ...
        $scope.myPromise = $http.get($scope.serverLocation +"/allpriority?OrganizationID="+$scope.OrganizationID)
                .success(function (response)
