...
$http.get( $scope.serverLocation +"/allemployees?empkey="+$scope.toServeremployeekey+"&OrganizationID="+$scope.OrganizationID).success(function(response){
 $scope.viewworkorder.workorderemployeeList = response;
});

$http.get( $scope.serverLocation +"/allWorkordertype?empkey="+$scope.toServeremployeekey+"&OrganizationID="+$scope.OrganizationID).success(function(response){
