...
$scope.scrollToTop = function() { //ng-click for back to top button
 ...
 $scope.scrollToTop();
      ...
      $scope.doRefreshEmployeeView = function(){
            ...
            // $ionicLoading.show();
          $scope.myPromise =  $http.get(HOSTNAME + "/viewDashboardWorkorder?viewdate="+$scope.today_DT+"&employeekey="+$scope.toServeremployeekey+"&OrganizationID="+$scope.OrganizationID)
