...
$scope.getBackgroundGeolocation($scope.toServeremployeekey);
 ...
 $scope.today_DT = convert_DT(new Date());
      ...
      $scope.myPromise =  $http.get(HOSTNAME+"/scanforWorkorder_emp?barcode="+$rootScope.inbarcode+"&empkey="+$scope.toServeremployeekey+"&ondate="+$scope.today_DT+"&OrganizationID="+$scope.OrganizationID)
